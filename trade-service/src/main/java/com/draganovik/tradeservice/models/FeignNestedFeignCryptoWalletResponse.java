...
public class FeignNestedFeignCryptoWalletResponse {
    private BigDecimal quantityBTC;
    private BigDecimal quantityETH;
    private BigDecimal quantityDOGE;

    public FeignNestedFeignCryptoWalletResponse() {
    }

    public FeignNestedFeignCryptoWalletResponse(FeignCryptoWalletResponse accountFeignResponse) {
