...
public class FeignNestedFeignBankAccountResponse {
    ...
    public FeignNestedFeignBankAccountResponse() {
    }

    public FeignNestedFeignBankAccountResponse(FeignBankAccountResponse accountFeignResponse) {
